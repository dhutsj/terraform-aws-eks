...
module "eks_managed_node_group" {
  ...
  for_each = { for k, v in var.eks_managed_node_groups : k => v if var.create_managed_node_group }

  create_managed_node_group = try(each.value.create_managed_node_group, false)
